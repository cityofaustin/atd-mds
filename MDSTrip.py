...
class MDSTrip:
    ...
    validation_schema = {
        ...
        "standard_cost": {"nullable": True, "required": False, "type": "integer"},
        "actual_cost": {"nullable": True, "required": False, "type": "integer"},
        "publication_time": {"nullable": True, "required": False, "type": "integer"},
