...
class MDSConfig:
    ...
    def __init__(self):
        ...
        self.ATD_MDS_CENSUS_GEOJSON = os.getenv("ATD_MDS_CENSUS_GEOJSON", "data/census_tracts_2010_simplified_20pct.json")
        self.ATD_MDS_COUNCIL_DIST_GEOJSON = os.getenv("ATD_MDS_COUNCIL_DIST_GEOJSON", "data/council_districts_simplified.json")
